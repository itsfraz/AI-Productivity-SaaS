...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-[#000000] p-4 relative overflow-hidden font-sans">
      <div className="absolute top-1/4 right-1/4 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[500px] lg:h-[500px] bg-primary-500/20 dark:bg-primary-500/10 rounded-full blur-[100px] pointer-events-none -z-10 animate-pulse-glow" />
      <div className="absolute bottom-1/4 left-1/4 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] lg:w-[400px] lg:h-[400px] bg-blue-500/20 dark:bg-blue-500/10 rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-zinc-900 dark:text-white tracking-tight mb-3">Create an account</h1>
          <p className="text-zinc-500 dark:text-zinc-400">Start boosting your productivity today.</p>
        </div>
        ...
        <div className="glass-panel p-8">
            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-primary-500">
                  <User className="h-5 w-5 text-zinc-400 dark:text-zinc-500 group-focus-within:text-primary-500 transition-colors" />
                </div>
                <input
                  type="text"
                  required
          ...
          <div className="mt-8 pt-6 border-t border-zinc-200/50 dark:border-zinc-800/50">
            <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">
              ...
              <Link to="/login" className="text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 font-medium transition-colors">
                Sign in
              </Link>
            </p>
          </div>
