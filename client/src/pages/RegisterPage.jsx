...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-[#000000] p-4 relative overflow-hidden font-sans">
      <div className="absolute top-1/4 right-1/4 w-[500px] h-[500px] bg-primary-500/20 dark:bg-primary-500/10 rounded-full blur-[100px] pointer-events-none -z-10 animate-pulse-glow" />
      <div className="absolute bottom-1/4 left-1/4 w-[400px] h-[400px] bg-blue-500/20 dark:bg-blue-500/10 rounded-full blur-[100px] pointer-events-none -z-10" />
